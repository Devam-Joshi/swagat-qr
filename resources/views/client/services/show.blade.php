...
@section('meta_keywords', $service['title'] . ', ' . $service['slug'] . ', digital services, famify creative')

{{-- Open Graph --}}
@section('og_title', $service['title'] . ' | Famify Creative')
@section('og_description', $service['description'])
@section('og_image', $service['image_1'])
                        ...
                        <div class="d-flex flex-column gspace-2">
                            ...
                            <p>
                                @if ($service['slug'] === 'social-media-marketing')
                                    At <strong>Famify Creative</strong>, we help brands grow through custom social media
                                    strategies that connect deeply with audiences and drive measurable results.
                                @elseif($service['slug'] === 'digital-marketing')
                                    Our digital marketing experts craft data-driven campaigns across SEO, content, and
                                    performance ads to elevate your brand visibility.
                                @elseif($service['slug'] === 'meta-ads-management')
                                    We specialize in targeted Meta Ads campaigns that convert clicks into customers and
                                    scale your reach profitably.
                                @elseif($service['slug'] === 'web-design')
                                    We design modern, responsive, and creative websites that represent your brand and
                                    convert visitors into loyal customers.
                                @elseif($service['slug'] === 'content-creative')
                                    Our content team creates eye-catching visuals, reels, and designs to boost engagement
                                    and brand awareness.
                                ...
                                @else
                                    Explore how Famify Creative can help your business grow through innovative marketing and
                                    design.
                                @endif
                            </p>
                            ...
                            <p>
                                With years of experience in digital marketing and design, we blend creativity with data to
                                deliver campaigns that truly perform.
                            </p>
