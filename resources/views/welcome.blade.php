            ...
            <div class="hero-container position-relative">
                <div class="d-flex flex-column gspace-2">
                    <h1 class="title-heading-banner animate-box animated animate__animated"
                        ...
                        Grow Your Brand with Famify Creative — Family-Driven Digital Marketing
                    </h1>
                    ...
                    <div class="row row-cols-xl-3 row-cols-md-2 row-cols-1 grid-spacer-2">
                        <div class="col">
                            <div class="card card-service animate-box animated slow animate__animated"
                                ...
                                <p>
                                    Build brand awareness & engage your audience effectively lorem ipsum dolor sit amet
                                    consectetur adip.
                                </p>
                            ...
                            <div class="card card-service animate-box animated animate__animated"
                                ...
                                <div
                                    ...
                                    <div>
                                        <div class="service-icon-wrapper">
                                            <div class="service-icon">
                                                <img src="./image/digital-marketing-icons-F4LJ4W8.png" alt="Service Icon"
                                                    class="img-fluid">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="testimonial-reviewer">
                                        <div class="avatar-container">
                                            <img src="./image/dummy-img-400x400.jpg" alt="Testimonial Reviewer"
                                                class="avatar">
                                            <img src="./image/dummy-img-400x400.jpg" alt="Testimonial Reviewer"
                                                class="avatar">
                                            <img src="./image/dummy-img-400x400.jpg" alt="Testimonial Reviewer"
                                ...
                                <div class="col">
                                    <div class="digital-process-step animate-box animated animate__animated"
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <img src="./image/digital-marketing-icons-N952ZWA.png"
                                ...
                                <div class="col">
                                    <div class="d-flex flex-md-row flex-column gspace-2 animate-box animated animate__animated"
                                        ...
                                        <div class="digital-process-step">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <img src="./image/Icon-11.png" alt="Digital Process Icon"
                                                        class="process-icon">
                                                </div>
                                                <span>02</span>
                                            </div>
                                ...
                                <div class="col">
                                    <div class="d-flex flex-md-row flex-column gspace-2 animate-box animated animate__animated"
                                        ...
                                        <div class="digital-process-step">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <img src="./image/Icon-10.png" alt="Digital Process Icon"
                                                        class="process-icon">
                                                </div>
                                                <span>03</span>
                                            </div>
                                ...
                                <div class="col">
                                    <div class="d-flex flex-md-row flex-column gspace-2 animate-box animated animate__animated"
                                        ...
                                        <div class="digital-process-step">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <img src="./image/Icon-12.png" alt="Digital Process Icon"
                                                        class="process-icon">
                                                </div>
                                                <span>04</span>
                                            </div>
                    ...
                    <div class="col">
                        <div class="card card-blog animate-box animated animate__animated"
                            ...
                            <div class="blog-image">
                                <img src="./image/dummy-img-600x400.jpg" alt="Blog Image" class="img-fluid">
                            </div>
                            <div class="card-body">
                                <div class="d-flex flex-row gspace-2">
                                    <div class="d-flex flex-row gspace-1 align-items-center">
